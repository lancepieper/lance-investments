...
export default function RegimeStressTester() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg,#0d1117 0%,#111820 40%,#0f1923 100%)", color: "#f0f0f0", fontFamily: "var(--font-geist-sans),system-ui,sans-serif" }}>
      ...
      <div className="rst-grid" style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 20, padding: "16px 28px 40px", alignItems: "start" }}>
